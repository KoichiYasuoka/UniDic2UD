...
if pl.startswith("CYGWIN"):
  install_requires=["ufal.udpipe>=1.2.0.3","mecab-cygwin>=0.5.0","deplacy>=2.1.1"]
else:
  import sys
  ...
  if useFugashi:
    install_requires=["ufal.udpipe>=1.2.0.3","fugashi>=1.3.3","deplacy>=2.1.1"]
  else:
    install_requires=["ufal.udpipe>=1.2.0.3","mecab-python3>=0.996.5","deplacy>=2.1.1"]
